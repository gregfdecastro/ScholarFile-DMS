    ...
    <div class="container mt-4">
        ...
        <div style="margin-top: 5%;" class="row">
            <div  class="col-md-12">
                <div style="max-width: 100%;" class="card">
                    <div class="card-header">
                        <h4>Project
                            <a href="project-create.php" class="btn btn-primary float-end">ADD </a>
                        </h4>
                    </div>
                    <div class="card-body">
            ...
            if (mysqli_num_rows($select) > 0) {
              while ($row = mysqli_fetch_assoc($select)) {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a style="font-size: medium; margin-right: 5%;" href="project-edit.php?edit=<?php echo $row['pid']; ?>" class="btn btn-success btn-sm">
                      <i class="fas fa-edit"></i> update </a>
                      <a style="font-size: medium;" href="project.php?delete=<?php echo $row['pid']; ?>" class="btn btn-danger btn-sm"
              ...
              echo "<div class='empty'>No Project Added</div>";
            }
            ;
            ?>
