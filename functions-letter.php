...
include("connection.php");
    ...
    if (isset($_POST['upload'])) {
        ...
        if (in_array($file_type, $allowTypes)) {
            $insert_query = mysqli_query($con, "INSERT INTO `letters`(title, uploaded_by, file) VALUES('$title', '$uploaded_by', '$file')") or die('query failed');
            ...
            if ($title == '' or $file == '') {
                ...
                header('location:letter-create.php');
            }
        }
    }
    ;
    ...
    if (isset($_GET['delete'])) {
        ...
        $delete_query = mysqli_query($con, "DELETE FROM `letters` WHERE letid = $delete_id ") or die('query failed');
        if ($delete_query) {
            header('location:letter.php');
 ...
 if (isset($_POST['update'])) {
    ...
    if (in_array($file_type, $allowTypes)) {
        $update_query = mysqli_query($con, "UPDATE `letters` SET title = '$update_title', file = '$update_file', uploaded_by = '$update_uploader' WHERE letid = '$update_id'");
        ...
        if ($update_query) {
            ...
            header('location:letter-edit.php');
        }
